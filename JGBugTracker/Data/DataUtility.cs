...
namespace JGBugTracker.Data
{
    public static class DataUtility
    {
        ...
        {
            //Provides an object representation opf a uniform resource identifier (URI) and easy access to the parts of the URI.
            var databaseUri = new Uri(databaseUrl);
            var userInfo = databaseUri.UserInfo.Split(':');
            //Provides a simple way to create and mange the contents of connection strings ised by the NpbsqlConnection class
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager)
        {
            ...
            try
            {
                //Test Database if User Already Exists
