...
namespace JGBugTracker.Data.Migrations
{
    ...
    [Migration("20221103153826_Updated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JGBugTracker.Models.BTUser", b =>
                {
            ...
            modelBuilder.Entity("JGBugTracker.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.ProjectPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BTUserProject", b =>
                {
                    b.HasOne("JGBugTracker.Models.BTUser", null)
                        .WithMany()
                        .HasForeignKey("MembersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JGBugTracker.Models.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JGBugTracker.Models.BTUser", b =>
                {
                    b.HasOne("JGBugTracker.Models.Company", "Company")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("JGBugTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("JGBugTracker.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("JGBugTracker.Models.Ticket", b =>
                {
                    b.HasOne("JGBugTracker.Models.BTUser", "DeveloperUser")
                        .WithMany()
                    ...
                    b.HasOne("JGBugTracker.Models.BTUser", "SubmitterUser")
                        .WithMany()
                        .HasForeignKey("SubmitterUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JGBugTracker.Models.TicketPriority", "TicketPriority")
                        .WithMany()
                        .HasForeignKey("TicketPriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JGBugTracker.Models.TicketStatus", "TicketStatus")
                        .WithMany()
                        .HasForeignKey("TicketStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JGBugTracker.Models.TicketType", "TicketType")
                        .WithMany()
            ...
            modelBuilder.Entity("JGBugTracker.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("JGBugTracker.Models.BTUser", "User")
                        .WithMany()
